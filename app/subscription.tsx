...
const PRIVACY_URL =
  "https://www.privacypolicies.com/live/fc87e6e8-e4d5-4250-8ee1-fa0b1af85a2e";
...
export default function Subscription() {
  ...
  const restore = React.useCallback(async () => {
    ...
    try {
      ...
      setPurchasing(false);
      Alert.alert("Erreur", "Vous n'avez pas d'achat à restaurer.");
      return;
    }
              ...
              <View style={styles.headerContainer}>
                <View>
                  <Text style={styles.planName}>
                    {offeringsParsed.current.serverDescription}
                  </Text>
                  <View style={styles.priceContainer}>
                    <Text style={styles.price}>
                      {
                        offeringsParsed.current.monthly.product
                          .pricePerMonthString
                      }
                    </Text>
