import { DEFAULT_COLOR, DEFAULT_KEY_COLOR, DEFAULT_KEY_IMAGE_URI, setStorageImageUri, themeColors, DEFAULT_IMAGE_URI, } from "@/theme/theme-storage";
import Animated, { FadeIn, FadeInDown, runOnJS, FadeOut } from "react-native-reanimated";
