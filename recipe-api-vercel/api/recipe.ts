  ...
  try {
    const response = await fetch(
      "https://openrouter.ai/api/v1/chat/completions",
      {
		...
		de certains condiments qui sont très facilement trouvables dans une cuisine française : huile, beurre, sel, poivre...  mais attention par exemple le pain, les pâtes, les oeufs sont facilements trouvables mais si l'utilisateur n'a pas mis ces ingrédients c'est qu'il ne veut pas les utiliser, fais bien attention quand tu proposes des ingredients supplémentaires.
